  ...
  return (
    <div>
        <div style={{display:'flex',justifyContent:'space-between',width:'100%'}}>
            <div>
                <input type="text" placeholder='Search upto three localities or landmarks'  style={{padding:'0.7rem',width:'30rem',marginTop:'0.5rem',marginBottom:'0.5rem',marginLeft:'2rem'}}/>
                <Button variant='contained' style={{backgroundColor:'red', borderRadius:'0px',padding:'0.5rem'}}>Search</Button>
            </div>
