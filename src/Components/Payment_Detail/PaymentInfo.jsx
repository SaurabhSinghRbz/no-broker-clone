  ...
  return (
    <Box>
      <Box pb="150px"  className={style.paymentInfoContainerPage} >
        ...
        <Box  display="flex" justifyContent="space-between"  className={style.paymentInfo_DetailNameTwo} >
          <Box>
            ...
            <Input w="340px" h="40px" className={style.inputName} placeholder='Enter Name'/>
          </Box>
          <Box>
            <FormLabel fontSize={14}>Landlord Name(As per bank records)</FormLabel>
            <Input w="340px" h="40px" className={style.inputName} type='tel' placeholder='phone number' />
          </Box>
        </Box>
        {/*  */}
        ...
        <Box  display="flex" justifyContent="space-between"  className={style.paymentInfo_DetailNameTwo} >
          <Box>
            ...
            <Input w="340px" h="40px" className={style.inputName} placeholder='Enter banks account number' />
          </Box>
          <Box>
            <FormLabel fontSize={14}>Confirm Account Number</FormLabel>
            <Input w="340px" h="40px" className={style.inputName} type='tel' placeholder="Re-enter bank's account number" />
          </Box>
        </Box>
        {/*  */}
        <Box  display="flex" justifyContent="space-between"  className={style.paymentInfo_DetailNameFour} >
          <Box>
            ...
            <Input w="340px" h="40px" className={style.inputName} placeholder='e.g. KKBK0000430' />
          </Box>
          <Box>
        ...
        <Box  display="flex" justifyContent="space-between"  className={style.paymentInfo_DetailNameFour} >
          <Box>
            ...
            <Input w="340px" h="40px" className={style.inputName} placeholder='Enter address' />
          </Box>
          <Box>
            <FormLabel fontSize={14}>Rent Amount</FormLabel>
            <Input w="340px" h="40px" className={style.inputName} type='tel' placeholder="Enter amount" />
          </Box>
        </Box>
        {/*  */}
      ...
      <Box display="flex" justifyContent="space-between" p="35px" borderTop="1px solid lightGray">
        ...
        <Button bg="red" color="white"> Save Payment Detail</Button>
      </Box>
    </Box>
  )
}
